...
start0 call game           ; start the game.
       jr start0
...
rpblc1 call rbloc          ; redraw blocks if in adventure mode.
...
cls    ld h,192            ; screen base is 256 * 192 = 49152.
       ld b,8              ; 8 rows per character.
cls0   push bc             ; store loop counter.
       call cls1           ; clear 25 lines.
       pop bc              ; restore loop counter.
       djnz cls0           ; repeat.
       ret
cls1   ld bc,1999          ; bytes to write.
       ld a,(papmsk)       ; get paper colour.
cls2   ld l,0              ; lines start at multiples of 256.
       ld d,h              ; copy hl to de.
       ld e,1              ; add 1 to de so it's pointing to next byte.
       ld (hl),a           ; write colour.
       ldir
       inc h               ; point hl at next block of lines.
       ret
...
rstrt0 xor a               ; zero in accumulator.
       ...
       call droom          ; show screen layout.
rpblc0 call rbloc          ; redraw blocks if in adventure mode.
...
xorbk  call gchadd         ; get character address.
       call gprad          ; get screen address in de.
       ex de,hl            ; screen in hl, block image in de.
...
xorbke ld a,(de)           ; get image byte.
       ...
       inc de              ; postincrement to next byte of data.
       ld (hl),a           ; write third byte.
       add hl,bc           ; look down one pixel.
       ret

xorbk0 call xorbko         ; odd pixel position.
       call xorbko
       call xorbko
       call xorbko
       call xorbko
...
xorbko ld a,(de)           ; get first byte of data to write.
       rra                 ; shift into right position.
       and 85              ; get right pixel colour.
...
joykey call 47908          ; get joystick states in hl.
       ...
       ld a,l              ; joystick 1.
       ld (joyval),a       ; store joystick reading.
       ret

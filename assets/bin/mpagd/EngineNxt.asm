...
; ZX Spectrum Next Engine v0.7.5
...
gtblk  ld (hl),0           ; make it empty now.
       ...
       ld b,8              ; number of pixel rows to write.
gtblk0 ld a,(de)           ; get screen byte.
       xor (hl)            ; merge with block image.
       ld (de),a           ; copy to screen.
       inc hl              ; next image byte.
       set 5,d             ; attribute screen.
       ld a,(hl)           ; get image byte.
       ...
       res 5,d             ; pixel screen.
       inc d               ; next screen row down.
       djnz gtblk0         ; repeat for 8 pixel rows.
       ret
...
clw2   ex af,af'           ; store column counter.
       ...
       ld hl,8192          ; distance between pixel and attribute.
       add hl,de           ; hl points to attributes.
       ex de,hl            ; flip attributes in de, pixels in hl.
       ld a,(23693)        ; get current colour attributes.
       ld b,8              ; pixel height of each cell.
clw1   ld (hl),0           ; clear byte of screen.
       inc h               ; one row down.
       ld (de),a           ; reset attribute.
       inc d               ; next screen row down.
       djnz clw1
